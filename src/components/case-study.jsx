  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        <div className="fixed left-5 basis-1/4">
          <Sidebar />
        </div>
        ...
        <div className="basic-3/4">
          <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <p className="p-5 text-ss-bl text-xl">
              SmoothSail is a self-hosted, open-source feature flag tool
              designed for small companies aiming for rapid feature development
              with minimized risks. It empowers developers to separate the
              release of new features from their deployment and quickly revert
              unsuccessful updates with just a click. SmoothSail provides
              accurate user targeting capabilities, enabling engineers to
              introduce new features to specific demographics and limit the
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              encompasses the installation of a different software version into
              a production environment. In other words, deployment involves
              transferring and configuring software files to the appropriate
              servers, ensuring all dependencies are satisfied and the
              application is ready for use. Release, on the other hand, is a
              process of making a part of the system (a feature) or a system as
              a whole available to the users.
            </p>
            <p className="flex justify-center pb-5">
              <img
            ...
            <p className="p-5 text-ss-bl text-xl">
              Conventionally, deployment and release schedules are tightly
              coupled together. The major disadvantages of this approach are the
              layer of complexity and inherent risk that can significantly
              impact the development lifecycle. For example, any delay, error,
              or complication in either deployment or release might delay future
              ...
              lengthy and complex. Therefore, a strong coupling of deployment
              and release processes can impede an engineering team’s ability to
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              significant issues, the load balancer can redirect the traffic
              back to the stable version of the application. <a href="#">REF</a>
            </p>
            <p className="flex justify-center pb-5">
              <img
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              application without automatically releasing the feature to the
              user base. Then, they release the new feature in a controlled
              manner by shifting user traffic from the stable version to the
              newly deployed one.
            </p>
            <p className="p-5 text-ss-bl text-xl">
            ...
            <ul className="p-5 text-ss-bl text-xl">
              ...
              <li className="list-disc ml-10">
                ...
                approach with blue-green deployment so that all application
                users will encounter any bugs. The canary deployment strategy
                minimizes the potential impact on the user base, but any bugs
                will still need redeployment or a hotfix.
              </li>
            </ul>
            <p className="p-5 text-ss-bl text-xl">
              Fortunately, there is a way to achieve the benefits that canary
              and blue-green offer while minimizing complexity and reducing the
              number of users impacted by unforeseen bugs in production code.
              This approach is called <strong>feature flags.</strong>
            </p>
            <div className="border-b border-ss-coral pb-5 pt-10">
              <h3 className="text-4xl font-semibold leading-6 text-ss-bl p-5">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              frontend, backend, or both. It allows the release of new features
              to be completely detached from deployment decisions.
            </p>
            <p className="flex justify-center pb-5">
              <img
            ...
            <ul className="p-5 text-ss-bl text-xl">
              <li className="list-disc ml-10">
                ...
                determine <strong>when</strong> and <strong>to whom</strong> a
                new feature is released. This flexibility allows the company to
                make features available when it is ready instead of when the new
                code is deployed. The release can target specific audiences,
                such as company employees or beta-testers, rather than the
                entire user base.
              </li>
              <li className="list-disc ml-10">
                <strong>Fast rollback</strong>: Disabling problematic features
                is simplified to a toggle switch, eliminating the need to roll
                back the entire release through redeployment.
              </li>
              <li className="list-disc ml-10">
              ...
              <li className="list-disc ml-10">
                <strong>Gentle learning curve</strong>: Feature flags are easy
                to adopt, minimizing the learning curve for engineers.
              </li>
              <li className="list-disc ml-10">
                ...
                <ul className="p-5 text-ss-bl text-xl">
                  <li className="list-disc ml-10">
                    ...
                    or monitoring the reliability and stability of a service
                    over time);
                  </li>
                  <li className="list-disc ml-10">
                    Simulated data or a subset of real data might not represent
                    the user population, which makes replication of the true
                    user population challenging;
                  </li>
                  <li className="list-disc ml-10">
                    Resource availability (e.g., time, budget, availability of
                    skilled specialists) limits what a company can achieve
                    during the software testing stage.
                  </li>
                </ul>
                <p>
                  Meanwhile, feature flags enable efficient and cost-effective
                  testing in a live environment. They allow for targeted testing
                  based on user attributes and quick feature rollbacks in case
                  of bugs. Moreover, feature flags play an instrumental role in
                  A/B testing, providing the flexibility to selectively expose
                  users to different variations and measure the impact of
                  changes, ultimately aiding in data-driven decision-making.
                </p>
              </li>
            </ul>
            <p className="p-5 text-ss-bl text-xl">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              making swift rollbacks possible but exposing the entire user base
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              comprehensive testing process. However, this approach risks
              exposing potential bugs to users who may not tolerate glitches,
              potentially leading to customer loss and reputation damage.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              ...
              information about a user. While this approach reduces the
              diversity of selected users, it also minimizes risks associated
              with feature releases. Introducing the new feature to a user group
              familiar with potential issues and willing to confront related
              risks may be prudent for companies concerned about the
              reputational and financial consequences of new feature releases.
            </p>
            <p className="p-5 text-ss-bl text-xl">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              ever-increasing impact. The team then initiates the feature
              release, starting from the innermost ring and progressing outward.
              Using one feature flag, developers can sequentially add sets of
              targeting rules (aka, segments) and gradually expand the audience
              for the new feature.
            </p>
            <p className="flex justify-center pb-5">
              <img
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              allowing for in-production testing, mitigating the risks of
              exposing potentially buggy features to the wrong demographics.
            </p>
            <div className="border-b border-ss-coral pb-5 pt-10"></div>
            <h4 className="text-2xl font-semibold leading-6 text-ss-bl p-5">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              deployment and release processes have a range of potential
              solutions at their disposal. They can opt for existing commercial
              solutions or pursue developing and creating the desired solution
              themselves.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              ...
              user-friendly setups and rich features, such as support for
              client- and server-side feature flag use, diverse user targeting
              capabilities (random and specific demographic targeting), various
              rollout strategies (percentage increase, ring rollout, hybrid),
              A/B testing, and feature flag metrics tracking.
            </p>
            <p className="p-5 text-ss-bl text-xl">
            ...
            <p className="p-5 text-ss-bl text-xl">
              SmoothSail is a self-hosted, open-source feature flag software
              that enables developer teams to release new features independently
              of deployment. It allows engineers to roll out features to
              specific user audiences based on user context and roll back
              unsuccessful features with the toggle of a flag.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              ...
              rollout to specific user demographics. SmoothSail grants its users
              a comprehensive oversight of both the application and feature flag
            ...
            <p className="p-5 text-ss-bl text-xl">
              We designed SmoothSail with reliability and consistency in mind.
              It was essential to ensure that when a user changes a feature
              flag, this change is immediately reflected in the consumer
              application. Therefore, the SmoothSail architecture consists of
              four major parts:
            </p>
            <ul className="p-5 text-ss-bl text-xl">
              <li className="list-disc ml-10">
              ...
              <li className="list-disc ml-10">
                <strong>NATS JetStream</strong> facilitates reliable
                communication between the Manager and SDK Service.
              </li>
              <li className="list-disc ml-10">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              built on React and allows users to view, create, update, and
              delete feature flag data. The dashboard is also where users can
              find their SDK key or regenerate the SDK key if it’s compromised.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              The <strong>Manager server</strong>, an Express application
              powered by Node.js, handles a range of responsibilities:
            </p>
            <ul className="p-5 text-ss-bl text-xl">
              <li className="list-disc ml-10">
              ...
              <li className="list-disc ml-10">
                Executes all <strong>CRUD database operations</strong> through
                the use of an ORM;
              </li>
              <li className="list-disc ml-10">
            ...
            <p className="p-5 text-ss-bl text-xl">
              We used a PostgreSQL database for persistent storage of
              flag-related data. We chose the SQL database because our data is
              highly structured. Furthermore, our emphasis on reliability
              mandated selecting an ACID-compliant database to ensure the
              steadfastness and integrity of our system.
            </p>
            <div className="border-b border-ss-coral pb-5 pt-10"></div>
            <h4 className="text-2xl font-semibold leading-6 text-ss-bl p-5">
              SDK Service
            ...
            <p className="p-5 text-ss-bl text-xl">
              The SDK Service, a backend application built on Node.js Express,
              is an intermediary between SmoothSail's Manager and the SDKs. Its
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              the SDK Key as an encrypted value in the Authorization header of
              an HTTP request to the SDK Service. In response, the SDK Service
              forwards the SDK Key to the Manager for authentication. Based on
              the Manager's validation, the SDK Service either establishes the
              SSE connection or denies the request.
            </p>
            <p className="p-5 text-ss-bl text-xl">
            ...
            <p className="p-5 text-ss-bl text-xl">
              The SDK Service manages the flag data within an in-memory cache.
              In the event of a flag update, the Manager server sends an update
            ...
            <p className="p-5 text-ss-bl text-xl">
              If SmoothSail users invalidate the current SDK key, the SDK
              Service promptly terminates all open SSE connections, forcing all
              SDKs to re-authenticate. To mitigate malicious connection
              attempts, we’ve incorporated a configurable rate limit for the SDK
              Service, which users can adjust based on their preferences
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              server and the SDK Service, our team chose NATS JetStream. NATS is
              a lightweight, high-performance messaging system that serves as a
              ...
              built–in persistence layer that provides additional
              functionalities such as at-least-once and exactly-once message
              delivery guarantees.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              Ensuring the reliable delivery of data between the Manager server
              and the SDK Service, we implemented NATS JetStream's "at least
              once" message delivery guarantee for all communication,
              configuring applications to acknowledge the receipt of the
              message.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              The SDK Service employs the NATS request-reply messaging pattern
              to retrieve initial complete flag data and SDK Key authentication.
              This communication method ensures that the requester (the SDK
              Service) awaits a response from the responder (the Manager
              server), facilitating a direct and reliable exchange of
              information.
            </p>
            <p className="flex justify-center pb-5">
              <img
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              SDK Service. The SDK Service subscribes to feature flag updates
              upon startup, acting as a subscriber. The Manager, designated as a
              publisher, relays information to the SDK Service. As SmoothSail is
              a self-hosted application, developers can scale the SDK Service
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              Service authentication URL. Developers can retrieve the current
              key or generate a new one using the SmoothSail UI. For enhanced
              ...
              SDK logs an error, starts serving flag default values, and
              refrains from further attempts at establishing an SSE connection.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              After successful authentication, the SDK receives the complete
              feature flag ruleset via the SSE connection. The connection is
              then kept alive for real-time notifications about changes on the
              feature flag manager platform. If a flag is changed, the SDK
              Service retransmits the complete feature flag information to the
              connected SDK, allowing it to update its in-memory information.
              Until the SDK receives the initial feature flag ruleset, all flags
              default to either a generic `false` value or the user-defined
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              lost, the SDK assumes the SSE connection is stale. Consequently,
              the SDK closes the stale connection and initiates a new attempt to
              establish a fresh one. Once successful, the SDK Service will
              resend the latest flag data to ensure any missed updates do not
              adversely affect the user's application. Users can adjust the
              heartbeat interval to suit their specific needs. It is noteworthy
              that since we prioritize consistency over availability in
              SmoothSail, SDK serves default feature flag values during the
              reconnection attempts, adopting a conservative approach to feature
              flag delivery in the event of SSE connection malfunction.
            </p>
            <div className="border-b border-ss-coral pb-5 pt-10"></div>
            <h4 className="text-2xl font-semibold leading-6 text-ss-bl p-5">
              Flag Evaluation
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              users, the flag remains unassociated with any segments,
              functioning as a straightforward toggle that turns on or off the
              feature for the entire user base. Conversely, if a flag is linked
              to at least one user segment, the user context is evaluated
              against each segment's user targeting conditions (aka segment
              rules). If the user aligns with the criteria of any segment, the
              flag evaluates to `true`; otherwise, it evaluates to `false`.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              Segments may encompass multiple rules. For example, a segment may
              require a user to be a beta-tester and an internal employee.
              Within a segment, the segment operator (either `all` or `any`)
              will dictate how the SDK will evaluate segment-associated rules.
              Under the `all` operator, every rule within a segment must be
              satisfied for the user to be placed within this segment and the
              flag to evaluate to `true`. In contrast, at least one rule must be
              fulfilled under the 'any' operator.
            </p>
            <p className="flex justify-center pb-5">
              <img
            ...
            <p className="p-5 text-ss-bl text-xl">
              As we do not expect our application to handle heavy database
              loads, the potential performance overhead of the ORM library isn't
              a concern. On the flip side, adopting the ORM library simplified
              the implementation of the following:
            </p>
            <ul className="p-5 text-ss-bl text-xl">
              <li className="list-disc ml-10">
                <strong>Transaction Atomicity:</strong> Ensuring the atomicity
                of multiple transactions through the ORM's built-in transaction
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              downtime could compromise the entire feature flag system.
              Moreover, the server's complexity was undergoing substantial
              growth. We opted to delegate some of the Manager's
              responsibilities to the SDK Service to enhance system robustness.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              The introduction of two servers, the Manager server and SDK
              Service, provides several key advantages:
            </p>
            <ul className="p-5 text-ss-bl text-xl">
              <li className="list-disc ml-10">
              ...
              <li className="list-disc ml-10">
                ...
                facilitates the implementation of distinct security levels for
                the feature flag Management platform and the SDK Service.
                Moreover, the SDK Service does not have direct access to the
                database, which mitigates the risk of potential threats and
                reduces the exposure of feature flag data;
              </li>
              <li className="list-disc ml-10">
            ...
            <p className="p-5 text-ss-bl text-xl">
              We recognize that this decision has its flaws: instead of managing
              a single Manager server, we now have two applications to oversee
              and ensure reliable communication. However, we believe that the
            ...
            <ul className="p-5 text-ss-bl text-xl">
              <li className="list-disc ml-10">
                <strong>Reliability:</strong> The communication channel had to
                be highly reliable;
              </li>
              <li className="list-disc ml-10">
                ...
                SDK Service. On the other hand, the SDK Service should be able
                to request complete feature flag ruleset on startup and new SDK
                authentication validation;
              </li>
              <li className="list-disc ml-10">
                <strong>Scalability:</strong> It should be able to scale
                together with the SDK Service without requiring additional
                configuration.
              </li>
            </ul>
            <p className="p-5 text-ss-bl text-xl">
            ...
            <ul className="p-5 text-ss-bl text-xl">
              ...
              <li className="list-disc ml-10">
                At least once: the message may be delivered multiple times, but
                it is guaranteed to be received at least once;
              </li>
              <li className="list-disc ml-10">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              the additional overhead associated with "exactly once" delivery,
              we opted for "at least once" delivery for our specific use case.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              Our team evaluated two message broker candidates that supported
              "at least once" message delivery: NATS JetStream and RabbitMQ.
              Several factors influenced the decision to choose NATS JetStream.
              First, NATS had lower latency specifications (p99 latency: 22.1ms)
              compared to RabbitMQ (p99 latency: 344ms) [ref]. Second, while
              RabbitMQ offered rich functionality, much of it would remain
              unused, creating unnecessary overhead for our application. Third,
              we found NATS easier to configure.
            </p>
            <p className="p-5 text-ss-bl text-xl">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              connections, its implementation would strain the Manager server
              due to its resource-intensive implementation.
            </p>
            <div className="border-b border-ss-coral pb-5 pt-10"></div>
            <h4 className="text-2xl font-semibold leading-6 text-ss-bl p-5">
            ...
            <p className="p-5 text-ss-bl text-xl">
              This choice mitigates the risk of serving outdated feature flag
              data in scenarios where messages regarding flag updates may fail
              to reach the SDK due to network issues. We reduce the likelihood
              of SDKs delivering stale information by consistently re-sending
              the complete flag ruleset with each change.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              ...
              SDK remains lightweight and minimizes the surface area for
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              comfortably within modern networks' capabilities. For
              significantly larger feature flag rulesets, developers can
              leverage SmoothSail's open-source nature to implement message
              compression logic, optimizing data transmission if needed.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              Although sending the complete feature flag ruleset every time a
              flag change occurs might increase message size, the trade-off is
              acceptable for SmoothSail's use case. We anticipate that a small
              engineering team will employ only a limited number of active
              feature flags for feature rollouts at any time.
            </p>
            <div className="border-b border-ss-coral pb-5 pt-10"></div>
            <h4 className="text-2xl font-semibold leading-6 text-ss-bl p-5">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              support. While external libraries can address this issue, this
              would result in additional dependencies and inflated SDK size.
              Furthermore, the bidirectional nature of WebSockets would
              introduce an unnecessary overhead for a one-way SDK Service - SDK
              connection.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              ...
              changes in flag data, most poll requests would be wasteful,
              placing unnecessary strain on the SDK Service.
            </p>
            <p className="flex justify-center pb-5">
              <img
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              increases. This insight was crucial for providing recommendations
              on optimizing the application's future use.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              To conduct a comprehensive assessment, we utilized Artillery.io
              for SmoothSail load testing. We used an SDK Service RESTful
              endpoint to set up the conditions for our load tests. This
              endpoint authenticated requests and transmitted data for 10
              feature flags upon successful validation. Despite our initial
              assumption that 10 requests/second (req/s) was reasonable for our
              use case and expected user numbers, we deliberately pushed the
              limits by significantly increasing the req/s to identify potential
              performance bottlenecks.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              The load test unfolded in three phases. The initial phase started
              at 1 req/s, gradually escalating to 10 req/s within 60 seconds.
              The second phase sustained the load at 10 req/s and further ramped
              up to 100 req/s over 60 seconds. The final phase maintained a load
              of 100 req/s and peaked at 1000 req/s.
            </p>
            <p className="p-5 text-ss-bl text-xl">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              with a single feature. Each flag will have the following
              properties:
            </p>
            <ul className="p-5 text-ss-bl text-xl">
              <li className="list-disc ml-10">
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              particular characteristic about a user. Some examples of
              attributes are `device`, `browser`, and `language`. These
              attributes are used to create rules within a segment. User context
              is expected to contain an attribute whose key is equal to the
              attribute key and the value to be specific to the user.
            </p>
            <p className="p-5 text-ss-bl text-xl">
              An attribute can be reused within different segments or multiple
              times within the same segment. This reuse of an attribute within
              the same segment allows for the case of different acceptable
              values. (ie. users with an email address ending in either
              @gmail.com or @yahoo.com). You can find more information on
              creating rules and using attributes in SmoothSail’s documentation
              on our GitHub organization page.
            </p>
            <p className="flex justify-center pb-5">
              <img
            ...
            <ul className="p-5 text-ss-bl text-xl">
              ...
              <li className="list-disc ml-10">
                <strong>description:</strong> description of the user
                demographic{" "}
              </li>
              <li className="list-disc ml-10">
              ...
              <li className="list-disc ml-10">
                <strong>rules:</strong> associated rules that place a user in
                this demographic or grouping
              </li>
            </ul>
            <p className="flex justify-center pb-5">
              <img
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              segment, the associated flag will be evaluated to true (assuming
              the flag is currently active).
            </p>
            <p className="p-5 text-ss-bl text-xl">
              Associating a segment with multiple flags, an engineer could
              release multiple features to users within a specific segment. An
              engineer can also add or remove segments associated with a flag at
              any time, thus continuing a feature’s release or rolling back the
              feature for specific demographics.
            </p>
            <div className="border-b border-ss-coral pb-5 pt-10"></div>
            <h4 className="text-2xl font-semibold leading-6 text-ss-bl p-5">
              Installation
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              applications. The first and easiest way is to make use of Docker.
              We offer a compose file that references SmoothSail’s latest images
              for each component, along with the latest images of PostgreSQL and
              NATS. These run in a single Docker network and can be configured
            ...
            <p className="p-5 text-ss-bl text-xl">
              Second, since SmoothSail is an open-source platform, developers
              can access and install each component via GitHub. Open access
              allows SmoothSail users to modify the application according to
              their specific requirements, offering greater control over its
            ...
            <p className="p-5 text-ss-bl text-xl">
              ...
              feature flag tool that empowers developer teams to release and
              roll back features seamlessly. It allows the creation of reusable
            ...
            <ul className="p-5 text-ss-bl text-xl">
              <li className="list-disc ml-10">
                ...
                comparisons between new features and the baseline, may enhance
                the rollout process. These metrics enable developers to swiftly
                identify and address potential application performance
                regressions related to new features, ensuring an optimized
                rollout experience [ref].
              </li>
              <li className="list-disc ml-10">
                <strong>Feature flag expiration.</strong> Once a feature is
                fully released to the user base, the corresponding flag becomes
                obsolete and should be promptly removed from the codebase. To
                facilitate this cleanup process and mitigate technical debt,
                introducing an option to set expiration dates for flags would be
                of use. When a flag exceeds its defined lifespan, its evaluation
                will log a warning, compelling developers to address and
                eliminate redundant feature flags systematically.
              </li>
              <li className="list-disc ml-10">
                <strong>Additional rollout strategies.</strong> Introducing a
                percentage rollout strategy would be valuable for feature
                releases that do not require specific user targeting but demand
                fine-grain control. Incrementally activating a new feature for a
                growing percentage of randomly selected users would enrich
