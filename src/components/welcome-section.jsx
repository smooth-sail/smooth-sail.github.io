      ...
      <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gradient-to-b from-ss-bl from-30% via-[#365A8F] via-60% to-[#406AA8] to-90% px-6 pb-4">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-ss-coral">{subtitle}</p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href={buttonPath}
                className="rounded-md bg-ss-blgr px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-ss-blgr-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                {button}
              </a>
              {/* <a
                href="https://github.com/smooth-sail"
